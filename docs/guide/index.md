...
- An ESM-friendly project, since the package publishes a root-only ESM entrypoint
...
Only the root package import is supported. Deep imports and subpath imports are intentionally not part of the public API.
